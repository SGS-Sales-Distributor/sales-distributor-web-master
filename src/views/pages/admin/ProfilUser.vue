                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <FormInput :class="errorField.description ? 'input-error' : ''" v-model="todo.description" @input="
                      (val) => 
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <FormInput :class="errorField.user_password ? 'input-error' : ''" v-model="todo.user_password" @input="
                      (val) => 
                        (todo.user_password = todo.user_password.trim())
                    "></FormInput>
                            </div>
                        </div>
                    </div>
    ...
    methods: {
            ...
            this.grid2.updateConfig({
                ...
                columns: [{
...

                    {
                        id: "description",
                        name: html(
                            '<div style="padding: 5px;border-radius: 5px;text-align: center;"><b>DESKRIPSI</b></div>'
                        ),
                    },
...

                    {
                        id: "departmentid",
                        name: html(
                            '<div style="padding: 5px;border-radius: 5px;text-align: center;"><b>Departemen</b></div>'
                        ),
                    },
              ...
              `
                ...
                server: {
                    url: 'http://localhost:8000/sgs/master_user',
                    then: (data) =>
        ...
        jqueryDelEdit() {
            ...
            $(document).on("click", "#editData", function () {
                ...
                mythis.$root.loader = true;
                axios
                    .get('http://localhost:8000/sgs/master_user/' + id)
                    .then((res) => {
                        mythis.acuanEdit = id;
        ...
        deleteTodo(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    mythis.$root.loader = true;
                    axios
                        .delete('http://localhost:8000/sgs/master_user/' + id, {
                            data: {
        ...
        saveTodo() {
            ...
            axios
                .post('http://localhost:8000/sgs/master_user', {
                    data: mythis.todo,
                    fileUpload: "form satuan",
                    userid: mythis.userid,
                })
        ...
        editTodo() {
            ...
            axios
                .put(
                    "http://localhost:8000/sgs/master_user/" + mythis.acuanEdit, {
                        data: mythis.todo2,
                        fileUpload: "form satuan",
                        userid: mythis.userid,
                    }
