                ...
                <div class="row">
                    <div class="col-md-3">
                        <button class="btn btn-sm btn-warning text-white" data-toggle="tooltip"
                            @click="exportDetailData()"><i class="fa-solid fa-file-excel"></i><span> Export Excel</span></button>
                    </div>
                </div>
            </div>
            <hr />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <FormInput :class="errorField.user_nik ? 'input-error' : ''"
                                                    v-model="todo2.user_nik" @input="(val) =>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <FormInput :class="errorField.user_fullname ? 'input-error' : ''"
                                                    v-model="todo2.user_fullname" @input="(val) =>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <FormInput :class="errorField.user_name ? 'input-error' : ''"
                                                    v-model="todo2.user_name" @input="(val) =>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <FormInput :class="errorField.user_email ? 'input-error' : ''"
                                                    v-model="todo2.user_email" @input="(val) =>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <v-select :options="cboCabang" v-model="cboCabangVal2"
                                                    @update:modelValue="mySelectEvent11_2()"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <v-select :options="cboOutlet" v-model="cboOutletVal2"
                                                    @update:modelValue="mySelectEvent22_2()"
                                                    :clearable="false"></v-select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <FormInput :class="errorField.user_phone ? 'input-error' : ''"
                                                    v-model="todo2.user_phone" @input="(val) =>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <v-select :options="cboUserTipeId" v-model="cboUserTipeIdVal2"
                                                    @update:modelValue="mySelectEvent33_2()"
                                                    :clearable="false"></v-select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <v-select :options="cboStatusBa" v-model="cboStatusBaVal2"
                                                    @update:modelValue="mySelectEvent44_2()"
                                                    :clearable="false"></v-select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <v-select :options="cboPenempatan" v-model="cboPenempatanVal2"
                                                    @update:modelValue="mySelectEvent55_2()"
                                                    :clearable="false"></v-select>
                                            </div>
                                        </div>
                                    </div>
...
export default {
    ...
    methods: {
        ...
        getCboUserType() {
            ...
            mythis.$root.loader = true;
            axios
                .get(import.meta.env.VITE_API_PATH + "http://localhost:8000/sgs/getCboUserType")
                .then((res) => {
        ...
        getCboStoreCabang(user_id) {
            var mythis = this;
            mythis.$root.loader = true;
            axios
                .get(import.meta.env.VITE_API_PATH + 'cabangsByUser/' + user_id)
                .then((res) => {
        ...
        jqueryDelEdit() {
            ...
            $(document).on("click", "#editData", function () {
                ...
                axios
                    .get(import.meta.env.VITE_API_PATH + 'api/v2/salesmenById/' + id, { headers: header })
                    .then((res) => {
                        mythis.acuanEdit = id;
