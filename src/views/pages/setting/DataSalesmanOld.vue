                    ...
                    <tbody>
                        <tr v-for="(item, idx) in salesman.data" :key="idx">
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-danger mx-1" data-bs-toggle="modal" data-bs-target="#deleteModal" @click="selectId(item.user_id)">Delete</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
...
<!-- <form @submit.prevent="storeNewData">
      <div class="form-group">
        ...
        <input type="text" v-model="formData.user_number" class="form-control" id="user_number" placeholder="Masukkan Number" />
      </div>
      <div class="form-group">
        <label for="user_nik" class="form-label">NIK <span class="form-required">*</span></label>
        <input type="text" v-model="formData.user_nik" class="form-control" id="user_nik" placeholder="Masukkan NIK" />
      </div>
      <div class="form-group">
        <label for="user_fullname" class="form-label">Fullname <span class="form-required">*</span></label>
        <input type="text" v-model="formData.user_fullname" class="form-control" id="user_fullname" placeholder="Masukkan Nama Lengkap" />
      </div>
      <div class="form-group">
        <label for="user_phone" class="form-label">Phone <span class="form-required">*</span></label>
        <input type="text" v-model="formData.user_phone" class="form-control" id="user_phone" placeholder="Masukkan No. Telp" />
      </div>
      <div class="form-group">
        <label for="user_email" class="form-label">User Email <span class="form-required">*</span></label>
        <input type="text" v-model="formData.user_email" class="form-control" id="user_email" placeholder="Masukkan User Email" />
      </div>
      <div class="form-group">
        <label for="user_name" class="form-label">Username <span class="form-required">*</span></label>
        <input type="text" v-model="formData.user_name" class="form-control" id="user_name" placeholder="Masukkan Username" />
      </div>
      <div class="form-group">
        <label for="user_password" class="form-label">Password <span class="form-required">*</span></label>
        <input type="text" v-model="formData.user_password" class="form-control" id="user_password" placeholder="Masukkan Password" />
      </div>
      <div class="form-group">
        <label for="user_type_id" class="form-label">User Type ID<span class="form-required">*</span></label>
        <select v-model="formData.user_type_id" class="form-select" id="user_type_id">
          <option value="">Pilih User Type ID</option>
      ...
      <div class="form-group">
        ...
        <input type="text" v-model="formData.user_status" class="form-control" id="user_status" placeholder="Masukkan Status" />
      </div>
      <div class="form-group">
        <label for="cabang_id" class="form-label">Cabang ID <span class="form-required">*</span></label>
        <input type="text" v-model="formData.cabang_id" class="form-control" id="cabang_id" placeholder="MasukkanCabang ID" />
      </div>
      <div class="form-group">
        <label for="store_id" class="form-label">Store ID <span class="form-required">*</span></label>
        <input type="text" v-model="formData.store_id" class="form-control" id="store_id" placeholder="Masukkan Store ID" />
      </div>
      <div class="form-group">
        <label for="status_ba" class="form-label">status BA <span class="form-required">*</span></label>
        <input type="text" v-model="formData.status_ba" class="form-control" id="status_ba" placeholder="Masukkan Status BA" />
      </div>
...
export default {
    ...
    methods: {
        ...
        async editData(data) {
            ...
            try {
                const response = await axios.get(`http://localhost:8000/sgs/user_info/${data.user_id}`);
                this.selectedData = response.data.data;
                this.selectedId = data.user_id;
                console.log(this.selectedData);
            } catch (error) {
        ...
        async updateData() {
            ...
            try {
                await axios.put(`http://localhost:8000/sgs/user_info/${this.selectedId}`, this.selectedData);
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil',
